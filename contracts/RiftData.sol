...
*/
contract RiftData is IRiftData, Ownable {
    mapping(address => bool) public riftControllers;

    uint256 public override karmaTotal;
    uint256 public override karmaHolders;

    mapping(uint256 => RiftBag) internal _bags;
    mapping(address => uint64) public override karma;
    mapping(address => bool) public xpControllers;
    mapping(uint256 => uint256) public override xpMap;
